...
# 设置输入输出文件
file_name_nopostfix = "矩阵k"
input_file = f'files/{file_name_nopostfix}.txt'
# 输出放代码结尾了


# 设置模型及网址
model1_name,model2_name='glm-4-air-0111','glm-4-air-0111'
model1_temperature,model2_temperature=0.01,0
base_url="https://open.bigmodel.cn/api/paas/v4/"
step2_switch=False #控制是否执行步骤2(即生成json)
...
time3 = time.time()
print(f"输出文件“{file_name_nopostfix}_{time_now}”成功，",f"总耗时：{time3-start_time:.2f}s")
